/*
 ...
 A simple web server that lets you blink an LED_BUILTIN via the web.
 ...
 * LED_BUILTIN attached to pin 2 for ESP32 DEVKIT1
 ...
 */
#define LED_BUILTIN 2 /// for esp32 DEVKIT1
#include <WiFi.h>
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/H\"> HIGH </a> LED ON.<br>");
            client.println();
            client.println();
            client.print("Click <a href=\"/L\"> LOW </a> LED OFF.<br></font>");
